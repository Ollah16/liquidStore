...
const Navlist = () => {
    ...
    return (
        <div className="before:lg:w-[2%] before:md:w-[1%] before:content-[''] before:inline-block flex bg-theme_hover border-b-[#649c00] border-b-[.5px] h-[48px] text-sm md:text-lg">

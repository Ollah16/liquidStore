                                ...
                                return (
                                    <React.Fragment key={inda}>
                                        <tr onClick={() => {
                                            ...
                                            <td className='max-w-[150px] px-2 overflow-hidden'>
                                                <h3 className='text-sm inline-block sm:text-base w-10/12 sm:w-full text-nowrap text-ellipsis overflow-hidden'>{state.transaction_description}</h3>
                                            </td>

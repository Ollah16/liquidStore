...
const Balance = () => {
    ...
    return (
        <div className='bg-gray-100 p-5'>
            ...
            <p className='flex items-baseline gap-x-3'><span className='font-semibold text-base md:text-lg tracking-tight flex items-center'>£{balance.toLocaleString()}</span><span className='font-light text-xs md:text-sm pl-5'>Balance after pending</span> </p>
        </div>
    )
}

...
const ExpandNav = () => {
    ...
    return (
        <nav className={`${isExpanded ? 'translate-x-0' : 'translate-x-[100%]'} right-0 md:hidden w-full bg-theme top-[94px] min-h-screen z-50 h-full transition-translate ease-in-out duration-300 fixed bottom-0 my-0`}>

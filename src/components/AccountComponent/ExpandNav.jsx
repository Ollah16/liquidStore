...
const ExpandNav = () => {
    ...
    return (
        <nav className={`${isExpanded ? 'translate-x-0' : 'translate-x-full'} right-0 md:hidden w-full bg-theme top-[94px] min-h-screen z-50 h-full transition-all ease-in-out duration-300 absolute bottom-0 my-0`}>

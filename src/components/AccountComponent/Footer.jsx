    ...
    return (
        <div className='w-full'>
            ...
            <div className='w-full lg:w-10/12 px-5 lg:px-0 mx-auto text-sm text-black/60 py-5'>
                <p className='mb-2'>Lloyds Bank plc is authorised by the Prudential Regulation Authority and regulated by the Financial Conduct Authority and the Prudential Regulation Authority under registration number 119278.</p>
                <p className='mb-2'>Lloyds Bank plc is covered by the Financial Services Compensation Scheme and the Financial Ombudsman Service. (Please note that due to the schemes eligibility criteria not all Lloyds Bank business customers will be covered by these schemes.)</p>

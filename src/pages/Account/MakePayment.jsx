                            ...
                            <div className='bg-white p-5'>
                                ...
                                <div className='my-5'>
                                    ...
                                    <div className='md:flex-row flex gap-x-8 flex-col gap-y-5'>
                                        ...
                                        <Link to={'/'} className='border hover:underline px-5 py-2 flex font-semibold text-theme border-theme w-full md:w-fit justify-center items-center gap-x-3'><span>Pay someone new</span> <TiPlus className='w-5 h-5' /></Link>
                                    </div>
                                </div>

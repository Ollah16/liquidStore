...
const CustomerSupport = () => {
    ...
    const supportProps = [
        ...
        },
        {
            ...
            linkClassName: 'bg-theme py-3 px-5 hover:underline w-full inline-block text-center text-white text-sm md:text-base font-bold hover:bg-[#024731] transition-colors ease-in-out duration-200',
            ...
            infoLink: '/',
            infoLinkClassName: 'bg-white text-theme hover:underline py-3 px-5 w-full inline-block text-center text-sm md:text-base',
